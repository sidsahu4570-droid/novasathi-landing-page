...
export default function Hero({ onOpenModal }) {
  ...
  return (
    <section className="hero-section content-container" aria-label="Hero Introduction">
      ...
      {/* ── 3. HERO CONTENT WRAPPED IN ONE LARGE PREMIUM GLASSMORPHISM CONTAINER ── */}
      <div className="hero-main-glass-panel">
        {/* Category Pill */}
        <div className="hero-top-banner-wrap" style={{ marginBottom: '16px', marginTop: '0' }}>
        ...
        <p
          className="hero-urgency-subheadline"
          style={{
